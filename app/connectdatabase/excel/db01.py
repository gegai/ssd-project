...
class ConnectDB(object):
    ...
    def insert_host(self,x):
        ...
        insert_host_sql='''INSERT INTO ssd_host(hostname,ip,mask,username,password,port,group_id)VALUES(%s,%s,%s,%s,%s,%s,%s);'''
        # ret_json = {'status': Constant.SUCCESS_CODE}
        ...
        try:
            ...
            for item in x:
                ...
                try:
                    ...
                    cur.execute(insert_host_sql,(item['hostname'],item['ip'], item['mask'], item['username'], item['password'], item['port'],id))
                    db.commit()
