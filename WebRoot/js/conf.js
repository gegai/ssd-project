...
function filter03(){
			...
			var grouphtml='';
            var local_hour_monitorinfor2 = 0;
			var local_min_monitorinfor2 = 0;
			var local_second_monitorinfor2 = 0;
			...
			$.ajax({
				...
				success:function(data){
					...
					for(var index in group_list){
                        ...
                        local_hour_monitorinfor2 = group_list[index].app_time_hour;
						local_min_monitorinfor2 = group_list[index].app_time_minute;
						local_second_monitorinfor2 = group_list[index].app_time_second;
						local_time_monitorinfor2 = group_list[index].config_time;
...
$(".addhostseem02").click(function(){
	...
	addhosthtml += '<div class="col-sm-10" style="float:left;"><input style="width:20%;float:left;" type="text" class="form-control" name="hour" id="hour" placeholder="'+local_hour_monitorinfor2+'"><span style="float:left;"> 时 </span>';
	...
	//addhosthtml += '<label for="ip" class="col-sm-2 control-label">分钟:</label>';<input type="search" value="请输入内容" onfocus="javascript:if(this.value=='请输入内容')this.value='';">

	addhosthtml += '<input style="width:20%;float:left;" type="text" class="form-control" name="minute" id="minute" placeholder="'+local_min_monitorinfor2+'"><span style="float:left;"> 分 </span>';
	...
	addhosthtml += '<input style="width:20%;float:left;" type="text" class="form-control" name="second" id="second" placeholder="'+local_second_monitorinfor2+'"><span> 秒</span></div>';
	...
	addhosthtml += '<div class="col-sm-10"><input type="text" class="form-control" name="config_time" id="config_time" placeholder="'+local_time_monitorinfor2+'(分钟)"></div>';
	...
	addhosthtml += '<div class="col-sm-10"><label for="mask" style="width:70%" class="col-sm-2 control-label">小时、分钟、秒合成一个时间作为后台主机轮询时间</label></div>';
            ...
            formSubmit: {
                ...
                action: function () {
					...
					if(bootstrapValidator.isValid()){
                        ...
                        var hour_data = $("#hour").val();
						var min_data = $("#minute").val();
						var sec_data = $("#second").val();
						var html_time = $("#config_time").val();
						if($("#minute").val() == ""){min_data = local_min_monitorinfor2};
						if($("#second").val() == ""){sec_data = local_second_monitorinfor2};
						if($("#hour").val() == ""){hour_data = local_hour_monitorinfor2};
						if($("#config_time").val() == ""){html_time = local_time_monitorinfor2};

						console.log('{"id":"50990","hour":"'+hour_data+'","minute":"'+min_data+'","second":"'+sec_data+'","config_time":"'+html_time+'"}')
						...
						$.ajax({
							...
							data:'{"id":"'+change_config_time+'","hour":"'+hour_data+'","minute":"'+min_data+'","second":"'+sec_data+'","config_time":"'+html_time+'"}',
